...
class Programa(models.Model):
    ...
    codigo = models.CharField(max_length=3, unique=True, verbose_name='Código del Programa')
    ...
    modalidad = models.CharField(max_length=3, choices=MODELO_CHOICES, verbose_name='Modalidad')
estado = models.CharField(max_length=3, choices=ESTADO_CHOICES, verbose_name='Estado')
