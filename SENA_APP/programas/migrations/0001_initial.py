    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_formacion', models.CharField(choices=[('AUX', 'Auxiliar'), ('GPE', 'Operario'), ('TEC', 'Tecnico'), ('TEL', 'Tecnologo'), ('ESP', 'Especialización Tecnológica'), ('COM', 'Complementario')], max_length=3, verbose_name='Nivel de Formación')),
                ('modalidad', models.CharField(choices=[('PRE', 'Pregrado'), ('VTI', 'Virtual'), ('MAX', 'Maxtech')], max_length=3, verbose_name='Modalidad')),
